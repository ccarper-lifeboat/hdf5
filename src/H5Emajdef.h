...
static const H5E_msg_t H5E_SCC_msg_s = {false, "Shared Chunk Cache", H5E_MAJOR, &H5E_err_cls_s};
...
static const H5E_msg_t H5E_STC_PLINE_msg_s = {false, "Data filters for structured chunk", H5E_MAJOR, &H5E_err_cls_s};
