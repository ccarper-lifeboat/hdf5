...
if((H5E_CANNOTGET_g = H5I_register(H5I_ERROR_MSG, &H5E_CANNOTGET_msg_s, false)) < 0)
    HGOTO_ERROR(H5E_ERROR, H5E_CANTREGISTER, FAIL, "can't register error message");
/* H5E_CANNOTGET_SELECTION */
assert(H5I_INVALID_HID == H5E_CANNOTGET_SELECTION_g);
if((H5E_CANNOTGET_SELECTION_g = H5I_register(H5I_ERROR_MSG, &H5E_CANNOTGET_SELECTION_msg_s, false)) < 0)
    HGOTO_ERROR(H5E_ERROR, H5E_CANTREGISTER, FAIL, "can't register error message");
/* H5E_CANNOTINSERT */
